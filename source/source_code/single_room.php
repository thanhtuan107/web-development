...
<body>
    ...
    <section class="describe">
        <div class="heading">describe heaven's single room</div>
        <div class="row">
            <div class="image">
                <img src="img/room_png/single_room.png" alt="">
            </div>
            <div class="txt_content">
                <p>Welcome to our Single's Room, a luxurious and cozy space perfect for a romantic getaway or honeymoon. As you step inside, you'll be greeted by a warm and inviting atmosphere, with soft lighting and tasteful decor to set the mood</p>
                <p>Our single room is a cozy and comfortable space, designed with the solo traveler in mind. With a comfortable bed and high-quality linens, you'll have a restful night's sleep. The room is equipped with a work desk and chair, perfect for catching up on work or planning your day's itinerary. Additionally, the room features a flat-screen TV, complimentary Wi-Fi, and a minibar stocked with a selection of refreshments. Whether you're here for business or leisure, our single room provides everything you need for a comfortable stay.</p>
            </div>
        </div>
    </section>
...
<form action="" method="post">
   ...
   <div class="flex">
      ...
      <!-- <div class="row">
        ...
        <a href="MainPage.php#room" class="fas fa-angle-right" style="font-size: 30px; color: #223F49" id="right-btn"></a>
        </select>
     </div> -->
