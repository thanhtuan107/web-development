...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="index.php#reservation">booking</a>
            <a href="index.php#room">catalogues</a>
            <a href="user_login.php">my bookings</a>
	    ...
	    <div class="box-container">
			...
			<div class="box">
					...
					<div class="content">
						...
						<p>single</p>
						<div class="icons">
							<a href="single_room.php#describe" class="fas fa-heart"></a>
							<a href="single_room.php#reservation" class="fas fa-clock"></a>
							<a href="single_room.php#fac" class="fas fa-eye"></a>
						</div>
						<div class="sub-room">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="swimming_pool.php" class="btn">visit now</a>
            </div>
        </div>
    </div>
</section>
