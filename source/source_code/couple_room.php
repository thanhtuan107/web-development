...
<body>
    ...
    <section class="describe">
        <div class="heading">describe heaven's couple room</div>
        <div class="row">
            <div class="image">
                <img src="img/room_png/couple_room.png" alt="">
            </div>
            <div class="txt_content">
                <p>Welcome to our Couple's Room, a luxurious and cozy space perfect for a romantic getaway or honeymoon. As you step inside, you'll be greeted by a warm and inviting atmosphere, with soft lighting and tasteful decor to set the mood</p>
                <p>Our couple's room is the perfect romantic retreat for couples seeking a private and intimate space. With its cozy and inviting atmosphere, comfortable king-sized bed, and luxurious amenities, such as a spa bathtub and premium toiletries, it's the ideal setting for a special getaway. Enjoy a glass of wine or champagne from the minibar and savor chocolate-covered strawberries while snuggled up in the comfortable armchairs. This room is sure to set the mood for a romantic and unforgettable stay.</p>
            </div>
        </div>
    </section>
   ...
   <div class="flex">
      ...
      <div class="row">
        ...
        <select name="room_type" class="input" required>
           <option value="couple room" selected>couple room</option>
        </select>
     </div>
   </div>
